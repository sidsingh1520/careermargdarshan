...
const Footer = () => {
    return <React.Fragment>
        <div class="grid grid-cols-4 gap-4 px-8 footer-section">
            <div className={columnDivStyle}>
                <p className={columnHeadingStyle}>
                    Services
                </p>
            ...
            <div className={columnDivStyle + ' text-center'}>
                ...
                <div className="flex justify-center">
                    ...
                    <img src={youtube} alt="no-img" className="footer-social-media-img"/>
