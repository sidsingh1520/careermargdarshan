...
const StudentBenefits = () => {
    return <div className="w-12/12 mt-8 pt-8">
        <p className="text-4xl text-center mb-8 font-bold">Students Benefited in the Past!</p>
        <div className="flex flex-wrap justify-center student-benefit-custom-bg px-8 mx-4">
            {
                studentBioData.map((items, index) => (
                    <div className="w-3/12 border mr-2 mb-8 px-4 py-2 bg-white student-benefit-custom-border">
                        <div className="flex justify-between w-full pl-4 mt-4 mb-8">
                            <img src={items.image_url} alt="no_image" className="student-rounded-image"/>
