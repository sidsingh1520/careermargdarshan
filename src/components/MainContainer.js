			...
			<div className="w-full flex flex-col items-center bg-gradient-to-t from-white via-green-200 to-white">
				...
				<div className="flex flex-col text-center items-center pt-16 font-bold">
					<p className="text-[28px] md:text-[48px] sm:text-[48px] leading-9 md:leading-relaxed sm:leading-6">
						...
						{width > 701 &&
							<span
								className="text-green-500 text-[28px] md:text-[48px] sm:text-[48px] leading-9 md:leading-relaxed sm:leading-6"
							>{currentItem}</span>}
					</p>
					{width < 701 && <span className="text-green-500 text-[28px] md:text-[48px] sm:text-[48px] leading-9 md:leading-relaxed sm:leading-6">{currentItem}</span>}
